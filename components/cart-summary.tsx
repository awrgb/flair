...
export function CartSummary() {
  ...
  const isDisable = isLoading || cartCount === undefined || cartCount === 0; // Ensure cartCount is defined and not zero
  const shippingAmount = cartCount !== undefined && cartCount > 0 ? 500 : 0; // Ensure cartCount is defined before checking if it's greater than zero
  const totalAmount = totalPrice !== undefined ? totalPrice + shippingAmount : 0; // Ensure totalPrice is defined before adding
